...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
  ...
  <div class="orderCurr" style="display: block;">
		...
		<input type="radio" name="paymentType" value="1"/>在线支付&nbsp;&nbsp;&nbsp;
		<input type="radio" name="paymentType" value="2"/>货到付款</div>
		<div class="shipment">
  ...
  <div class="backToCart"><a style=" text-decoration:underline;" target="" href="/order/order-cart.html">返回修改购物车</a></div>
			...
			<div class="orderTbl">
				...
				<div class="orderPInfo">
					...
					<div class="pItem pGoods">
						<a href="http://localhost:8087/item/${cart.id}.html" target="_blank">${cart.title }</a>
					</div>
